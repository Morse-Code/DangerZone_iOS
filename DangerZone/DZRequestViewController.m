       ...
       inComponent:(NSInteger)component
{
    ...
    if (component == 0) { // category selected
        [self.attributes setValue:[NSNumber numberWithInt:(NSUInteger)row] forKey:@"category"];
    }
    else  {   // radius selected        
...
- (IBAction)onRequestPressed:(id)sender
{
    ...
    [DZObject dangerZoneObjectsForOperation:@"request"  WithParameters:(NSDictionary *)self.attributes AndBlock:
